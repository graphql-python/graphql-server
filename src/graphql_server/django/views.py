...
from .context import GraphQLDjangoContext
...
class GraphQLView(
    ...
    schema: GraphQLSchema = None  # type: ignore
    ...
    def get_context(self, request: HttpRequest, response: HttpResponse) -> Context:
        return None
        # raise NotImplementedError("Implement this method in your view")
...
class AsyncGraphQLView(
    ...
    async def get_context(
        ...
        return GraphQLDjangoContext(request=request, response=response)  # type: ignore
