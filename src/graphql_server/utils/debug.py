...
class GraphQLJSONEncoder(JSONEncoder):
...
def pretty_print_graphql_operation(
    ...
    try:
        ...
        raise ImportError(
            ...
            "directly or run `pip install graphql_server[debug-server]`"
        ) from e
    ...
    if variables:
        variables_json = json.dumps(variables, indent=4, cls=GraphQLJSONEncoder)
