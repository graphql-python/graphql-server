...
if TYPE_CHECKING:
    from graphql_server.test import BaseGraphQLTestClient
...
async def aiohttp_graphql_client() -> AsyncGenerator[BaseGraphQLTestClient]:
    try:
        ...
        from graphql_server.aiohttp.test import GraphQLTestClient
...
async def asgi_graphql_client() -> AsyncGenerator[BaseGraphQLTestClient]:
    try:
        ...
        from graphql_server.asgi.test import GraphQLTestClient
    except ImportError:
