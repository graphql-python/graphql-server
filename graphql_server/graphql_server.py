...
class GraphQLParams(NamedTuple):
    """GraphQL params of the data."""
    query: Optional[Any]
...
class GraphQLResponse(NamedTuple):
    """NamedTuple with the list of ExecutionResults as first item
...
class ServerResponse(NamedTuple):
    """NamedTuple with the serialized response as the first item and
