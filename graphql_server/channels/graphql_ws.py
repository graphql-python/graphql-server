...
from graphql_server.websockets.ws_protocol import BaseGraphQLWSHandler, OperationMessage
...
class GraphQLWSHandler(BaseGraphQLWSHandler):
    ...
    async def handle_request(self) -> Any:
        await self._ws.accept(subprotocol=BaseGraphQLWSHandler.PROTOCOL)
